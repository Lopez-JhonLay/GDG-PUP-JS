...
// Using let
let name = "Jhon Lay Lopez"; // Define a string here, e.g., "Juan Cruz"
let age = 22; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["coding", "gaming", "singing"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
// Using var
var city = "Pasay City"; // Define a string here, e.g., "New York"
var temperature = 100; // Define a number here, e.g., 22.5
